...
## DevOps = Agile + Automation + Operations + Ownership

## Waterfall vs Agile vs DevOps
Waterfall → Agile → DevOps (evolution)
#### Stage 1: Waterfall : Sequential execution
...
#### Stage 2: Agile : Break work into small iterations (sprints)
